...
<style scoped>
  ...
  .pagination__button {
    ...
    border-radius: 50%;
    border: clamp(1.5px, 0.2vw, 2px) solid rgba(255, 255, 255, 0.3);
  ...
  .pagination__line-progress {
    ...
    box-shadow: 0 0 clamp(4px, 1vw, 8px) rgba(238, 93, 34, 0.5);
  }
  ...
  .pagination__label {
    ...
    color: var(--dt-white);
    white-space: nowrap;
    padding: clamp(0.25rem, 0.5vw, 0.5rem) clamp(0.75rem, 1.5vw, 1.5rem);
