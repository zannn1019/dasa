...
export interface ApiAboutSectionAboutSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    gallery: Schema.Attribute.Component<'shared.slider', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mission: Schema.Attribute.Component<'missions.mission', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBlogSettingBlogSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rssFeedUrl: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    buttonLink: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'/about#contact'>;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subServices: Schema.Attribute.Component<'shared.sub-service', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    technologies: Schema.Attribute.Component<'shared.technology-tag', true>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    social: Schema.Attribute.Component<'socmed.social-media', true>;
